...
namespace Gw2LogParser.GW2EIBuilders
{
    ...
    public class JsonNPC : JsonActor
    {
        ...
        internal JsonNPC(NPC npc, ParsedLog log, RawFormatSettings settings, Dictionary<string, JsonLog.SkillDesc> skillDesc, Dictionary<string, JsonLog.BuffDesc> buffDesc) : base(npc, log, settings, skillDesc, buffDesc)
        {
