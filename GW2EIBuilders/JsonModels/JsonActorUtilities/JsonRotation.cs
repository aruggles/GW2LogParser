...
namespace Gw2LogParser.GW2EIBuilders
{
    ...
    public class JsonRotation
    {
        ...
        protected JsonRotation(ParsedLog log, long skillID, List<AbstractCastEvent> skillCasts, Dictionary<string, JsonLog.SkillDesc> skillDesc)
        {
        ...
        internal static List<JsonRotation> BuildJsonRotationList(ParsedLog log, Dictionary<long, List<AbstractCastEvent>> skillByID, Dictionary<string, JsonLog.SkillDesc> skillDesc)
        {
