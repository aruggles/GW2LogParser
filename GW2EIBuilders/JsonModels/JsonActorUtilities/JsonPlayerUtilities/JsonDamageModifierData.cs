...
namespace Gw2LogParser.GW2EIBuilders
{
    public class JsonDamageModifierData
    {
        ...
        internal static List<JsonDamageModifierData> GetDamageModifiers(Dictionary<string, List<DamageModifierStat>> damageModDict, ParsedLog log, Dictionary<string, JsonLog.DamageModDesc> damageModDesc)
        {
        ...
        internal static List<JsonDamageModifierData>[] GetDamageModifiersTarget(Player player, ParsedLog log, Dictionary<string, JsonLog.DamageModDesc> damageModDesc)
        {
