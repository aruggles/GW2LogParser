...
namespace Gw2LogParser.GW2EIBuilders
{
    public class JsonLog
    {
        ...
        public class SkillDesc
        {
            ...
            internal SkillDesc(Skill item, ulong gw2Build, SkillData skillData)
            {
                Name = item.Name;
                AutoAttack = item.AA;
                Icon = item.Icon;
                CanCrit = Skill.CanCrit(item.ID, gw2Build);
                IsSwap = item.IsSwap;
        ...
        public class BuffDesc
        {
            ...
            internal BuffDesc(Buff item, ParsedLog log)
            {
                Name = item.Name;
                Icon = item.Link;
        ...
        internal JsonLog(ParsedLog log, RawFormatSettings settings, string[] uploadLinks)
        {
            //
            ...
            if (mechanicLogs.Any())
            {
                Mechanics = JsonMechanics.GetJsonMechanicsList(mechanicLogs);
            }
            //
