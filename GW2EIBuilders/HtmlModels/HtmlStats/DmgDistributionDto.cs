...
namespace Gw2LogParser.GW2EIBuilders
{
    public class DmgDistributionDto
    {
        ...
        internal static DmgDistributionDto BuildDMGTakenDistData(ParsedLog log, AbstractSingleActor p, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DmgDistributionDto BuildDMGDistDataInternal(ParsedLog log, FinalDPS dps, AbstractSingleActor p, NPC target, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DmgDistributionDto();
            PhaseData phase = log.FightData.GetPhases(log)[phaseIndex];
        ...
        internal static DmgDistributionDto BuildPlayerDMGDistData(ParsedLog log, Player p, NPC target, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        internal static DmgDistributionDto BuildTargetDMGDistData(ParsedLog log, NPC target, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DmgDistributionDto BuildDMGDistDataMinionsInternal(ParsedLog log, FinalDPS dps, Minions minions, NPC target, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DmgDistributionDto();
            PhaseData phase = log.FightData.GetPhases(log)[phaseIndex];
        ...
        internal static DmgDistributionDto BuildPlayerMinionDMGDistData(ParsedLog log, Player p, Minions minions, NPC target, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            FinalDPS dps = p.GetDPSTarget(log, phaseIndex, target);
        ...
        internal static DmgDistributionDto BuildTargetMinionDMGDistData(ParsedLog log, NPC target, Minions minions, int phaseIndex, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            FinalDPS dps = target.GetDPSAll(log, phaseIndex);
