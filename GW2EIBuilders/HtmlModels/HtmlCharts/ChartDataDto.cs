...
namespace Gw2LogParser.GW2EIBuilders
{
    public class ChartDataDto
    {
        ...
        internal static List<object[]> BuildHealthGraphStates(ParsedLog log, AbstractSingleActor actor, PhaseData phase, bool nullable)
        {
        ...
        internal static List<object[]> BuildBreakbarPercentStates(ParsedLog log, NPC npc, PhaseData phase)
        {
        ...
        internal static ChartDataDto BuildChartData(ParsedLog log)
        {
