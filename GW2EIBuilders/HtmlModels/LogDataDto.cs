...
namespace Gw2LogParser.GW2EIBuilders
{
    public class LogDataDto
    {
        ...
        internal static LogDataDto BuildLogData(ParsedLog log, Dictionary<long, Skill> usedSkills,Dictionary<long, Buff> usedBuffs, HashSet<DamageModifier> usedDamageMods, bool cr, bool light, string[] uploadLinks)
        {
