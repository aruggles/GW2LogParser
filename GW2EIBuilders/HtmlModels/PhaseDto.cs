...
namespace Gw2LogParser.GW2EIBuilders
{
    ...
    public class PhaseDto
    {
        ...
        internal PhaseDto(PhaseData phaseData, List<PhaseData> phases, ParsedLog log)
        {
            Name = phaseData.Name;
        ...
        internal static List<List<object>> BuildDPSData(ParsedLog log, int phaseIndex)
        {
        ...
        internal static List<List<List<object>>> BuildDPSTargetsData(ParsedLog log, int phaseIndex)
        {
        ...
        internal static List<List<object>> BuildDMGStatsData(ParsedLog log, int phaseIndex)
        {
        ...
        internal static List<List<List<object>>> BuildDMGStatsTargetsData(ParsedLog log, int phaseIndex)
        {
        ...
        internal static List<List<object>> BuildDefenseData(ParsedLog log, int phaseIndex)
        {
            var list = new List<List<object>>();
        ...
        internal static List<List<object>> BuildSupportData(ParsedLog log, int phaseIndex)
        {
            var list = new List<List<object>>();
