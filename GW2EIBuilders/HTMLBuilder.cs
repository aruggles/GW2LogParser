...
namespace GW2EIBuilders
{
    public class HTMLBuilder
    {
        ...
        {
            string html = Gw2LogParser.Properties.Resources.tmplMain;
            ...
            html = html.Replace("<!--${CompressionUtils}-->", _compressJson ? Gw2LogParser.Properties.Resources.compressionUtils : "");
        ...
        {
            string scriptContent = Gw2LogParser.Properties.Resources.css;
            bool externalNull = string.IsNullOrEmpty(externalPath);
            bool cdnNull = string.IsNullOrEmpty(cdnPath);
            if (!externalNull || !cdnNull)
            {
