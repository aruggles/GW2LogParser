...
namespace Gw2LogParser.GW2EIBuilders
{
    internal static class EXTJsonBarrierStatsBuilderCommons
    {
        ...
        private static EXTJsonBarrierDist BuildBarrierDist(long id, List<EXTAbstractBarrierEvent> list, ParsedLog log, Dictionary<string, JsonLog.SkillDesc> skillDesc, Dictionary<string, JsonLog.BuffDesc> buffDesc)
        {
        ...
        internal static List<EXTJsonBarrierDist> BuildBarrierDistList(Dictionary<long, List<EXTAbstractBarrierEvent>> dlsByID, ParsedLog log, Dictionary<string, JsonLog.SkillDesc> skillDesc, Dictionary<string, JsonLog.BuffDesc> buffDesc)
        {
