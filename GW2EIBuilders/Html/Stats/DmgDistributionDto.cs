...
namespace Gw2LogParser.GW2EIBuilders
{
    public class DmgDistributionDto
    {
        ...
        public static DmgDistributionDto BuildDMGTakenDistData(ParsedLog log, AbstractSingleActor p, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DmgDistributionDto BuildDMGDistDataInternal(ParsedLog log, FinalDPS dps, AbstractSingleActor p, AbstractSingleActor target, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DmgDistributionDto();
        ...
        public static DmgDistributionDto BuildFriendlyDMGDistData(ParsedLog log, AbstractSingleActor actor, AbstractSingleActor target, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        public static DmgDistributionDto BuildTargetDMGDistData(ParsedLog log, AbstractSingleActor npc, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DmgDistributionDto BuildDMGDistDataMinionsInternal(ParsedLog log, FinalDPS dps, Minions minions, AbstractSingleActor target, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DmgDistributionDto();
        ...
        public static DmgDistributionDto BuildFriendlyMinionDMGDistData(ParsedLog log, AbstractSingleActor actor, Minions minions, AbstractSingleActor target, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            FinalDPS dps = actor.GetDPSStats(target, log, phase.Start, phase.End);
        ...
        public static DmgDistributionDto BuildTargetMinionDMGDistData(ParsedLog log, AbstractSingleActor target, Minions minions, PhaseData phase, Dictionary<long, Skill> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
