...
namespace Gw2LogParser.Parser.Logic
{
    internal class Qadim : MythwrightGambit
    {
        ...
        public Qadim(int triggerID) : base(triggerID)
        {
            ...
            {
            new EnemyCastStartMechanic(51943, "Qadim CC", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "Q.CC","Qadim CC", "Qadim CC",0),
            ...
            new HitOnPlayerMechanic(52224, "Fire Wave", new MechanicPlotlySetting("circle-open",Colors.Orange), "D.Wave","Fire Wave (Shockwave after Destroyer's Jump or Stomp)", "Destroyer Shockwave",0),
            new HitOnPlayerMechanic(52520, "Elemental Breath", new MechanicPlotlySetting("triangle-left",Colors.Red), "Hydra Breath","Elemental Breath (Hydra Breath)", "Hydra Breath",0),
            new HitOnPlayerMechanic(53013, "Fireball", new MechanicPlotlySetting("circle-open",Colors.Yellow,10), "H.FBall","Fireball (Hydra)", "Hydra Fireball",0),
            new HitOnPlayerMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("circle-open",Colors.Pink), "H.Meteor","Fiery Meteor (Hydra)", "Hydra Meteor",0),
            new EnemyCastStartMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "H.CC","Fiery Meteor (Hydra Breakbar)", "Hydra CC",0),
            //new Mechanic(718, "Fiery Meteor (Spawn)", Mechanic.MechType.EnemyBoon, ParseEnum.BossIDS.Qadim, new MechanicPlotlySetting("diamond-tall",Colors.DarkRed), "H.CC.Fail","Fiery Meteor Spawned (Hydra Breakbar)", "Hydra CC Fail",0,(condition =>  condition.CombatItem.IFF == ParseEnum.IFF.Foe)),
            new EnemyCastEndMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "H.CCed","Fiery Meteor (Hydra Breakbar broken)", "Hydra CCed",0,(ce, log) => ce.ActualDuration < 12364),
            new EnemyCastEndMechanic(52941, "Fiery Meteor", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "H.CC Fail","Fiery Meteor (Hydra Breakbar not broken)", "Hydra CC Failed",0, (ce,log) => ce.ActualDuration >= 12364),
            new HitOnPlayerMechanic(53051, "Teleport", new MechanicPlotlySetting("circle",Colors.Purple), "H.KB","Teleport Knockback (Hydra)", "Hydra TP KB",0),
            new HitOnPlayerMechanic(52310, "Big Hit", new MechanicPlotlySetting("circle",Colors.Red), "Mace","Big Hit (Mace Impact)", "Mace Impact",0),
            new HitOnPlayerMechanic(52587, "Inferno", new MechanicPlotlySetting("triangle-down-open",Colors.Red), "Inf.","Inferno (Lava Pool drop  on long platform spokes)", "Inferno Pool",0),
            new HitOnPlayerMechanic(51958, "Slash (Wyvern)", new MechanicPlotlySetting("triangle-down-open",Colors.Yellow), "Slash","Wyvern Slash (Double attack: knock into pin down)", "KB/Pin down",0),
            new HitOnPlayerMechanic(52705, "Tail Swipe", new MechanicPlotlySetting("diamond-open",Colors.Yellow), "W.Pizza","Wyvern Tail Swipe (Pizza attack)", "Tail Swipe",0),
            new HitOnPlayerMechanic(52726, "Fire Breath", new MechanicPlotlySetting("triangle-right-open",Colors.Orange), "W.Breath","Fire Breath (Wyvern)", "Fire Breath",0),
            new HitOnPlayerMechanic(52734, "Wing Buffet", new MechanicPlotlySetting("star-diamond-open",Colors.DarkTeal), "W.Wing","Wing Buffet (Wyvern Launching Wing Storm)", "Wing Buffet",0),
            new EnemyCastStartMechanic(53132, "Patriarch CC", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "W.BB","Platform Destruction (Patriarch CC)", "Patriarch CC",0),
            new EnemyCastEndMechanic(53132, "Patriarch CC", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "W.CCed","Platform Destruction (Patriarch Breakbar broken)", "Patriarch CCed",0, (ce, log) => ce.ActualDuration < 6500),
            new EnemyCastStartMechanic(51984, "Patriarch CC (Jump into air)", new MechanicPlotlySetting("diamond-tall",Colors.Red), "Wyv CC Fail","Platform Destruction (Patriarch Breakbar failed)", "Patriarch CC Fail",0),
            new HitOnPlayerMechanic(52330, "Seismic Stomp", new MechanicPlotlySetting("star-open",Colors.Yellow), "D.Stomp","Seismic Stomp (Destroyer Stomp)", "Seismic Stomp (Destroyer)",0),
            new HitOnPlayerMechanic(51923, "Shattered Earth", new MechanicPlotlySetting("hexagram-open",Colors.Red), "D.Slam","Shattered Earth (Destroyer Jump Slam)", "Jump Slam (Destroyer)",0),
            new HitOnPlayerMechanic(51759, "Wave of Force", new MechanicPlotlySetting("diamond-open",Colors.Yellow), "D.Pizza","Wave of Force (Destroyer Pizza)", "Destroyer Auto",0),
            new EnemyCastStartMechanic(52054, "Summon", new MechanicPlotlySetting("diamond-tall",Colors.DarkTeal), "D.CC","Summon (Destroyer Breakbar)", "Destroyer CC",0),
            new EnemyCastEndMechanic(52054, "Summon", new MechanicPlotlySetting("diamond-tall",Colors.DarkGreen), "D.CCed","Summon (Destroyer Breakbar broken)", "Destroyer CCed",0, (ce, log) => ce.ActualDuration < 8332),
            new EnemyCastEndMechanic(52054, "Summon", new MechanicPlotlySetting("diamond-tall",Colors.Red), "D.CC Fail","Summon (Destroyer Breakbar failed)", "Destroyer CC Fail",0, (ce,log) => ce.ActualDuration >= 8332),
            new SpawnMechanic(20944, "Summon (Spawn)", new MechanicPlotlySetting("diamond-tall",Colors.DarkRed), "D.Spwn","Summon (Destroyer Trolls summoned)", "Destroyer Summoned",0),
            new HitOnPlayerMechanic(51879, "Body of Flame", new MechanicPlotlySetting("star-open",Colors.Pink,10), "P.AoE","Body of Flame (Pyre Ground AoE (CM))", "Pyre Hitbox AoE",0),
            ...
            new KilledMechanic((int)ArcDPSEnums.TrashID.PyreGuardianRetal, "Retal Pyre Guardian", new MechanicPlotlySetting("bowtie",Colors.LightRed), "Pyre.R.K","Retal Pyre Killed", "Retal Pyre Killed",0),
            new KilledMechanic((int)ArcDPSEnums.TrashID.PyreGuardianResolution, "Resolution Pyre Guardian", new MechanicPlotlySetting("bowtie",Colors.LightRed), "Pyre.R.K","Resolution Pyre Killed", "Resolution Pyre Killed",0),
            });
            Extension = "qadim";
        ...
        {
            IReadOnlyList<Agent> pyres = agentData.GetNPCsByID((int)ArcDPSEnums.TrashID.PyreGuardian);
            // Lamps
            var lampAgents = combatData.Where(x => x.DstAgent == 14940 && x.IsStateChange == ArcDPSEnums.StateChange.MaxHealthUpdate).Select(x => agentData.GetAgent(x.SrcAgent, x.Time)).Where(x => x.Type == Agent.AgentType.Gadget && x.HitboxWidth == 202).ToList();
            foreach (Agent lamp in lampAgents)
            {
                lamp.OverrideType(Agent.AgentType.NPC);
                lamp.OverrideID(ArcDPSEnums.TrashID.QadimLamp);
            }
            bool refresh = lampAgents.Count > 0;
            // Pyres
            foreach (Agent pyre in pyres)
            {
                Combat position = combatData.FirstOrDefault(x => x.SrcMatchesAgent(pyre) && x.IsStateChange == ArcDPSEnums.StateChange.Position);
                if (position != null)
                {
        ...
        {
            // Find target
            Agent target = agentData.GetNPCsByID((int)ArcDPSEnums.TargetID.Qadim).FirstOrDefault();
            if (target == null)
            {
                throw new MissingKeyActorsException("Qadim not found");
            }
            Combat startCast = combatData.FirstOrDefault(x => x.SkillID == 52496 && x.StartCasting());
            Combat sanityCheckCast = combatData.FirstOrDefault(x => (x.SkillID == 52528 || x.SkillID == 52333 || x.SkillID == 58814) && x.StartCasting());
        ...
        private static void AddPlatformsToCombatReplay(NPC target, ParsedLog log, CombatReplay replay)
        {
