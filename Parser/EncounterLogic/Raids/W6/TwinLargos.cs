...
namespace Gw2LogParser.Parser.Logic
{
    internal class TwinLargos : MythwrightGambit
    {
        ...
        private static List<PhaseData> GetTargetPhases(ParsedLog log, AbstractSingleActor target, string baseName)
        {
            long start = 0;
            long end = 0;
        ...
        private static void FallBackPhases(AbstractSingleActor target, List<PhaseData> phases, ParsedLog log, bool firstPhaseAt0)
        {
            IReadOnlyCollection<Agent> pAgents = log.PlayerAgents;
