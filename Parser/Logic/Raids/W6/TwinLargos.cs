...
namespace Gw2LogParser.Parser.Logic
{
    internal class TwinLargos : RaidLogic
    {
        ...
        internal override List<AbstractDamageEvent> SpecialDamageEventProcess(Dictionary<Agent, List<AbstractDamageEvent>> damageBySrc, Dictionary<Agent, List<AbstractDamageEvent>> damageByDst, Dictionary<long, List<AbstractDamageEvent>> damageById, SkillData skillData)
        {
        ...
        {
            HashSet<Agent> pAgents = log.PlayerAgents;
