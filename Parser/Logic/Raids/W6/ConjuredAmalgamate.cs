...
namespace Gw2LogParser.Parser.Logic
{
    internal class ConjuredAmalgamate : RaidLogic
    {
        ...
        internal override void EIEvtcParse(FightData fightData, AgentData agentData, List<Combat> combatData, List<Player> playerList)
        {
            ...
            List<Agent> cas = agentData.GetGadgetsByID((int)ArcDPSEnums.TargetID.ConjuredAmalgamate);
            List<Agent> leftArms = agentData.GetGadgetsByID((int)ArcDPSEnums.TargetID.CALeftArm);
            List<Agent> rightArms = agentData.GetGadgetsByID((int)ArcDPSEnums.TargetID.CARightArm);
            ...
            Agent sword = agentData.AddCustomAgent(fightData.FightStart, fightData.FightEnd, Agent.AgentType.Player, "Conjured Sword\0:Conjured Sword\051", "Sword", 0);
