...
namespace Gw2LogParser.Parser.Extensions
{
    public class EXTFinalOutgoingHealingStat
    {
        ...
        internal EXTFinalOutgoingHealingStat(ParsedLog log, long start, long end, AbstractSingleActor actor, AbstractSingleActor target)
        {
        ...
        private static (int healing, int healingPowerHealing, int conversionHealing, int hybridHealing, int downedHealing) ComputeHealingFrom(ParsedLog log, IReadOnlyList<EXTAbstractHealingEvent> damageEvents)
        {
            int healing = 0;
