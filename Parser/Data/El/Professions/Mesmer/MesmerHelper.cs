...
namespace Gw2LogParser.Parser.Data.El.Professions
{
    internal static class MesmerHelper
    {
        ...
        {
            new DamageCastFinder(10212, 10212, InstantCastFinders.InstantCastFinder.DefaultICD), // Power spike
            new BuffLossCastFinder(10233, 10233, InstantCastFinders.InstantCastFinder.DefaultICD, (brae, combatData) => {
