...
namespace Gw2LogParser.Parser.Data.El.Professions
{
    internal static class GuardianHelper
    {
        internal static readonly List<InstantCastFinder> InstantCastFinder = new List<InstantCastFinder>()
        {
            ...
            //new BuffLossCastFinder(9115,9114,InstantCastFinders.InstantCastFinder.DefaultICD), // Virtue of Justice
            //new BuffLossCastFinder(9120,9119,InstantCastFinders.InstantCastFinder.DefaultICD), // Virtue of Resolve
            //new BuffLossCastFinder(9118,9113,InstantCastFinders.InstantCastFinder.DefaultICD), // Virtue of Courage
