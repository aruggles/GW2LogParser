...
namespace Gw2LogParser.Parser.Data.El.Professions
{
    internal static class FirebrandHelper
    {
        ...
        {
            new DamageCastFinder(46618,46618,InstantCastFinders.InstantCastFinder.DefaultICD), // Flame Rush
            new DamageCastFinder(46616,46616,InstantCastFinders.InstantCastFinder.DefaultICD), // Flame Surge
            //new DamageCastFinder(42360,42360,InstantCastFinders.InstantCastFinder.DefaultICD), // Echo of Truth
            //new DamageCastFinder(44008,44008,InstantCastFinders.InstantCastFinder.DefaultICD), // Voice of Truth
        };
