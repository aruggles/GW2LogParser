...
namespace Gw2LogParser.Parser.Data.El.Statistics
{
    public class FinalBuffsDictionary
    {
        ...
        internal static (FinalBuffsDictionary, FinalBuffsDictionary) GetFinalBuffsDictionary(ParsedLog log, Buff buff, BuffDistribution buffDistribution, long phaseDuration, long activePhaseDuration)
        {
