...
{
    class SingleActorDamageModifierHelper : AbstractSingleActorHelper
    {
        ...
        private Dictionary<string, DamageModifierStat> ComputeDamageModifierStats(AbstractSingleActor target, ParsedLog log, long start, long end)
        {
        ...
        public IReadOnlyDictionary<string, DamageModifierStat> GetDamageModifierStats(AbstractSingleActor target, ParsedLog log, long start, long end)
        {
            ...
            foreach (Agent actor in damageModifiersEventsByTarget.Keys)
            {
