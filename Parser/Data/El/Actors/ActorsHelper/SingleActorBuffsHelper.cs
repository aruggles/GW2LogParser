...
namespace Gw2LogParser.Parser.Data.El.Actors.ActorsHelper
{
    internal class SingleActorBuffsHelper : AbstractSingleActorHelper
    {
        ...
        private void ComputeBuffMap(ParsedLog log)
        {
            //
        ...
        private void SetBuffGraphs(ParsedLog log)
        {
        ...
        private (Dictionary<long, FinalBuffsDictionary>, Dictionary<long, FinalBuffsDictionary>) ComputeBuffsDictionary(ParsedLog log, long start, long end)
        {
