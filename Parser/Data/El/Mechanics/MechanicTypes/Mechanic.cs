...
namespace Gw2LogParser.Parser.Data.El.Mechanics.MechanicTypes
{
    ...
    public abstract class Mechanic
    {
        ...
        internal abstract void CheckMechanic(ParsedLog log, Dictionary<Mechanic, List<MechanicEvent>> mechanicLogs, Dictionary<int, AbstractSingleActor> regroupedMobs);
