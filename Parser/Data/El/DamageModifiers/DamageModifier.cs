...
namespace Gw2LogParser.Parser.Data.El.DamageModifiers
{
    public abstract class DamageModifier : IVersionable
    {
        ...
        public List<AbstractDamageEvent> GetHitDamageLogs(Player p, ParsedLog log, NPC t, PhaseData phase)
        {
            switch (_srcType)
            {
                case DamageType.All:
        ...
        internal abstract void ComputeDamageModifier(Dictionary<string, List<DamageModifierStat>> data, Dictionary<NPC, Dictionary<string, List<DamageModifierStat>>> dataTarget, Player p, ParsedLog log);
