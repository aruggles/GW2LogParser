...
namespace Gw2LogParser.Parser.Data.Events.MetaData
{
    public class SkillInfoEvent : AbstractMetaDataEvent
    {
        ...
        internal SkillInfoEvent(Combat evtcItem) : base(evtcItem)
        {
            SkillID = evtcItem.SkillID;
            CompleteSkillInfoEvent(evtcItem);
        }

        internal void CompleteSkillInfoEvent(Combat evtcItem)
        {
        ...
        private void BuildFromSkillInfo(Combat evtcItem)
        {
        ...
        private void BuildFromSkillTiming(Combat evtcItem)
        {
