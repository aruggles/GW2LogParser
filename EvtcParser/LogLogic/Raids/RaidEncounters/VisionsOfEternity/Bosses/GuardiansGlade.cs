...
internal class GuardiansGlade : VisionsOfEternityRaidEncounter
{
    ...
    internal readonly MechanicGroup Mechanics = new([
        ...
        new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic([KelaStompLeft, KelaStompRight], Mech_KelaStomp, new (Symbols.TriangleLeft, Colors.Orange), new ("Stomp.H", "Hit by Stomp", "Stomp Hit"), Sev2)
                .WithStabilitySubMechanic(
                    new SubMechanic(Mech_KelaStompCC, new (Symbols.TriangleLeftOpen, Colors.Orange), new ("Stomp.CC", "CC by Stomp", "Stomp CC"), Sev0),
                    false
                ),
        ]),
        // Kela Claw Slam
        new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic(KelaClawSlam, Mech_KelaClawSlam, new (Symbols.TriangleUp, Colors.Orange), new ("ClawSlam.H", "Hit by ClawSlam", "ClawSlam Hit"), Sev2)
                .WithStabilitySubMechanic(
                    new SubMechanic(Mech_KelaClawSlamCC, new (Symbols.TriangleUpOpen, Colors.Orange), new ("ClawSlam.CC", "CC by ClawSlam", "ClawSlam CC"), Sev0),
                    false
                ),
        ]),
        // Lightning Strike
        new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic(KelaLightningStrike, Mech_KelaLightningStrike, new (Symbols.Circle, Colors.LightOrange), new ("LightStk.H", "Hit by Lightning Strike", "Lightning Strike Hit"), Sev1)
                .WithStabilitySubMechanic(
                    new SubMechanic(Mech_KelaLightningStrikeCC, new (Symbols.CircleOpen, Colors.LightOrange), new ("LightStk.CC", "CC by Lightning Strike", "Lightning Strike CC"), Sev0, 10),
                    false
                ),
        ]),
        // Crocodilian Razortooth Tackle
        new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic(CrocodilianRazortoothTackle, Mech_KelaCrocTackle, new (Symbols.TriangleDown, Colors.Red), new ("CrocTackle.H", "Hit by Crocodilian Razortooth Tackle", "Croc Tackle Hit"), Sev0)
                .WithStabilitySubMechanic(
                    new SubMechanic(Mech_KelaCrocTackleCC, new (Symbols.TriangleDownOpen, Colors.Red), new ("CrocTackle.CC", "CC by Crocodilian Razortooth Tackle", "Croc Tackle CC"), Sev0),
                    false
                ),
        ]),
        // Tornado
        new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic(KelaTornado, Mech_KelaTornado, new (Symbols.YUp, Colors.Grey), new ("Tornado.H", "Hit by Tornado", "Tornado Hit"), Sev2)
                .WithStabilitySubMechanic(
                    new SubMechanic(Mech_KelaTornadoCC, new (Symbols.YUpOpen, Colors.Grey), new ("Tornado.CC", "CC by Tornado", "Tornado CC"), Sev0),
                    false
                ),
        ]),
        new PlayerDstHealthDamageHitMechanic([KelaAmbush1, KelaAmbush2], Mech_KelaAmbush, new (Symbols.CircleX, Colors.Red), new ("Ambush.H", "Hit by Ambush", "Ambush Hit"), Sev0),
        new PlayerDstHealthDamageHitMechanic([KelaTantrum1, KelaTantrum2], Mech_KelaTantrum, new (Symbols.Square, Colors.BreakbarActiveBlue), new ("Tantrum.H", "Hit by Tantrum", "Tantrum"), Sev1),
        new PlayerDstHealthDamageHitMechanic(ScaldingWave, Mech_ScaldingWave, new (Symbols.Star, Colors.Blue), new ("ScalWave.H", "Hit by Scalding Wave", "Scalding Wave Hit"), Sev0),
        new PlayerDstBuffApplyMechanic(FixatedKela, Mech_KelaFixated, new (Symbols.Star,Colors.Magenta), new ("Fixated", "Fixated by Kela", "Kela Fixated"), Sev0),
        new PlayerDstBuffApplyMechanic(Hunted, Mech_Hunted, new (Symbols.Star, Colors.Red), new ("Croc.Fix", "Fixated by Crocodilian Razortooth", "Croc Fixated"), Sev1),
        new PlayerDstBuffApplyMechanic(ShreddedArmor, Mech_ShreddedArmor, new (Symbols.Octagon, Colors.LightRed), new ("ShredArmor.A", "Applied Shredded Armor", "Shredded Armor Applied"), Sev0),
        // Loose Sand
        new MechanicGroup([
            new PlayerDstBuffApplyMechanic(LooseSand, Mech_LooseSand, new (Symbols.Bowtie, Colors.LightPurple), new ("LooSand.A", "Applied Loose Sand", "Loose Sand Applied"), Sev2),
            new MechanicGroup([
                new AchievementEligibilityMechanic(Ach_Surefooted, Mech_AchSurefootedLost, new (Symbols.Bowtie, Colors.DarkPurple), new ("Achiv.Sand.L", "Achievement Eligibility: Surefooted Lost", "Achiv: Surefooted Lost"))
                    .UsingChecker((evt, log) => evt.Lost),
                new AchievementEligibilityMechanic(Ach_Surefooted, Mech_AchSurefootedKept, new (Symbols.Bowtie, Colors.Purple), new ("Achiv.Sand.K", "Achievement Eligibility: Surefooted Kept", "Achiv: Surefooted Kept"))
                    .UsingChecker((evt, log) => !evt.Lost)
            ]),
        ]),
        // Biting Swarm
        new MechanicGroup([
            new PlayerDstBuffApplyMechanic(BitingSwarm, Mech_BittingSwarm, new (Symbols.Diamond, Colors.Orange), new ("Bee", "Biting Swarm Application", "Biting Swarm"), Sev3)
                .WithSubMechanic(new SubMechanic(Mech_BittingSwarmFirst, new (Symbols.Diamond, Colors.Orange), new ("Bee.First", "Biting Swarm First Application", "First Biting Swarm"), Sev0), (time, actor, log) => IsFirstBee(time, actor.AgentItem, log))
                .WithSubMechanic(new SubMechanic(Mech_BittingSwarmContaminated, new (Symbols.DiamondOpen, Colors.Orange), new ("Bee.Cntmntd", "Contaminated by Bitting Swarm", "Contaminated by Bitting Swarm "), Sev0), (time, actor, log) => !IsFirstBee(time, actor.AgentItem, log))
                .UsingIgnored()
        ]),
        new EnemyDstBuffApplyMechanic(RelentlessSpeed, Mech_RelentlessSpeed, new (Symbols.Hourglass, Colors.Blue), new ("Speed", "Gained Relentless Speed", "Relentless Speed Applied"), Sev2),
        // Eating
        new MechanicGroup([
            new EnemySrcHealthDamageMechanic(ArcDPSGenericKill, Mech_AteCroc, new (Symbols.StarDiamond, Colors.Red), new ("Ate Croc", "Ate a Crocodilian Razortooth", "Ate Croc"), Sev1)
                .UsingChecker((hde, log) => hde.To.IsSpecies(TargetID.DownedEliteCrocodilianRazortooth)),
            new EnemySrcHealthDamageMechanic(ArcDPSGenericKill, Mech_AteArtifact, new (Symbols.StarDiamondOpen, Colors.Red), new ("Ate Artifact", "Ate the Cursed Artifact", "Ate Artifact"), Sev0)
                .UsingChecker((hde, log) => hde.To.IsSpecies(TargetID.CursedArtifact_NPC)),
            new MechanicGroup([
                new EnemySrcHealthDamageMechanic(ArcDPSGenericKill, Mech_AtePlayer, new (Symbols.StarSquare, Colors.Red), new ("Ate Player", "Ate a Player", "Ate Player"), Sev0)
                    .UsingChecker((hde, log) => hde.To.IsPlayer),
                new PlayerDstHealthDamageMechanic(ArcDPSGenericKill, Mech_PlayerEaten, new (Symbols.StarTriangleUp, Colors.Red), new ("Player Eaten", "Player Eaten", "Player Eaten"), Sev0)
                    .UsingChecker((hde, log) => hde.From.IsSpecies(TargetID.KelaSeneschalOfWaves))
                    .WithSubMechanic(
                        new SubMechanic(Mech_TankEaten, new (Symbols.StarTriangleUpOpen, Colors.Red), new ("Tank Eaten", "Tank Eaten", "Tank Eaten"), Sev0)
