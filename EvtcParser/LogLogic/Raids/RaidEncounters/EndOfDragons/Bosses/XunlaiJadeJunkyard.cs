...
internal class XunlaiJadeJunkyard : EndOfDragonsRaidEncounter
{
    public XunlaiJadeJunkyard(int triggerID) : base(triggerID)
    {
        MechanicList.Add(new MechanicGroup([
            new PlayerDstHealthDamageHitMechanic(GraspingHorror, Mech_GraspingHorror, new (Symbols.CircleCrossOpen, Colors.LightOrange), new("Hands.H", "Hit by Hands AoE", "Hands Hit"), Sev1, 150),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(DeathsEmbraceSkill, Mech_DeathsEmbrace, new (Symbols.CircleCross, Colors.DarkRed), new("AnkkaPull.H", "Hit by Death's Embrace (Ankka's Pull)", "Death's Embrace Hit"), Sev0, 150),
                new EnemyCastStartMechanic(DeathsEmbraceSkill, Mech_DeathsEmbraceCast, new (Symbols.CircleXOpen, Colors.Blue), new("AnkkaPull.C", "Casted Death's Embrace", "Death's Embrace Cast"), Sev3, 150),
            ]),
            new MechanicGroup([
                new PlayerDstHealthDamageHitMechanic(DeathsHandInBetween, Mech_DeathsHandInBetween, new (Symbols.TriangleUp, Colors.Yellow), new("Sctn.AoE.H", "Hit by in-between sections AoE", "Death's Hand Hit (transitions)"), Sev3, 150),
                new PlayerDstHealthDamageHitMechanic(DeathsHandDropped, Mech_DeathsHandDropped, new (Symbols.TriangleDown, Colors.Green), new("Sprd.AoE.H", "Hit by placeable Death's Hand AoE", "Death's Hand Hit (placeable)"), Sev1, 150),
                new PlayerDstBuffApplyMechanic(DeathsHandSpreadBuff, Mech_DeathsHandTarget, new (Symbols.TriangleLeft, Colors.Green), new("Sprd.AoE.B", "Received Death's Hand Spread", "Death's Hand Spread"), Sev2, 150),
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic(ImminentDeathSkill, Mech_ImminentDeath, new (Symbols.DiamondTall, Colors.Green), new("Imm.Death.H", "Hit by Imminent Death", "Imminent Death Hit"), Sev0),
                    new PlayerDstBuffApplyMechanic(ImminentDeathBuff, Mech_ImminentDeathApply, new (Symbols.DiamondOpen, Colors.Green), new("Imm.Death.B", "Placed Death's Hand AoE and gained Imminent Death Buff", "Imminent Death Buff"), Sev1, 150),
                ]),
            ]),
            // Extra adds
            new MechanicGroup([
                // Kraits
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic(WallOfFear, Mech_WallOfFear, new (Symbols.TriangleRight, Colors.DarkRed), new("Krait.H", "Hit by Krait AoE", "Krait Hit"), Sev0, 150),
                ]),
                // Quaggans
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic([WaveOfTormentNM, WaveOfTormentCM], Mech_WaveOfTorment, new (Symbols.Circle, Colors.DarkRed), new("Quaggan.H", "Hit by Quaggan Explosion", "Quaggan Hit"), Sev0, 150),
                ]),
                // Lich
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic(TerrifyingApparition, Mech_TerrifyingApparition, new (Symbols.TriangleLeft, Colors.DarkRed), new("Lich.H", "Hit by Lich AoE", "Lich Hit"), Sev0, 150),
                    new PlayerDstBuffApplyMechanic(AnkkaLichHallucinationFixation, Mech_TerrifyingApparitionTarget, new (Symbols.Diamond, Colors.LightBlue), new("Lich.H.F", "Fixated by Lich Hallucination", "Lich Fixation"), Sev0, 150),
                ]),
                new MechanicGroup([
                    new AchievementEligibilityMechanic(Ach_Clarity, Mech_ClarityLost, new (Symbols.DiamondTall, Colors.DarkBlue), new("Clarity.Achiv.L", "Achievement Eligibility: Clarity Lost", "Achiv Clarity Lost"))
                            .UsingChecker((evt, log) => evt.Lost),
                    new AchievementEligibilityMechanic(Ach_Clarity, Mech_ClarityKept, new (Symbols.DiamondTall, Colors.Blue), new("Clarity.Achiv.K", "Achievement Eligibility: Clarity Kept", "Achiv Clarity Kept"))
                            .UsingChecker((evt, log) => !evt.Lost)
                ]),
                // Reaches
                new MechanicGroup([
                    new PlayerDstHealthDamageHitMechanic([ZhaitansReachThrashXJJ1, ZhaitansReachThrashXJJ2], Mech_XJJZhaitansReachPull, new (Symbols.CircleOpen, Colors.DarkGreen), new("ZhtRch.Pull", "Pulled by Zhaitan's Reach", "Zhaitan's Reach Pull"), Sev2, 150),
                    new PlayerDstHealthDamageHitMechanic([ZhaitansReachGroundSlam, ZhaitansReachGroundSlamXJJ], Mech_XJJZhaitansReachKnock, new (Symbols.CircleOpenDot, Colors.DarkGreen), new("ZhtRch.Knck", "Knocked by Zhaitan's Reach", "Zhaitan's Reach Knock"), Sev2, 150),
                ]),
                // Hallucinations
                new MechanicGroup([
                    new PlayerDstBuffApplyMechanic(Hallucinations, Mech_XJJHallucinations, new (Symbols.Square, Colors.LightBlue), new("Hallu", "Received Hallucinations Debuff", "Hallucinations Debuff"), Sev1, 150),
                ]),
                // Hatred
                new MechanicGroup([
                    new PlayerDstBuffApplyMechanic(FixatedAnkkaKainengOverlook, Mech_HatredFixated, new (Symbols.Diamond, Colors.Purple), new("Fxt.Hatred", "Fixated by Reanimated Hatred", "Fixated Hatred"), Sev1, 150),
                ]),
            ]),
            new EnemyCastStartMechanic(InevitabilityOfDeath, Mech_InevitabilityOfDeath, new (Symbols.Octagon, Colors.LightRed), new("Inev.Death.C", "Casted Inevitability of Death (Enrage)", "Inevitability of Death (Enrage)"), Sev3, 150),
            new EnemyDstBuffApplyMechanic(PowerOfTheVoid, Mech_PowerOfTheVoid, new (Symbols.Star, Colors.Yellow), new("Pwrd.Up", "Ankka has powered up", "Ankka powered up"), Sev0, 150),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(DevouringVoid, Mech_DevouringVoid, new (Symbols.DiamondWide, Colors.LightBlue), new("DevVoid.B", "Received Devouring Void", "Devouring Void Applied"), Sev1, 150),
                new MechanicGroup([
                    new AchievementEligibilityMechanic(Ach_Undevoured, Mech_UndevouredLost, new (Symbols.DiamondWide, Colors.DarkBlue), new("Undev.Achiv.L", "Achievement Eligibility: Undevoured Lost", "Achiv Undevoured Lost"))
                            .UsingChecker((evt, log) => evt.Lost),
                    new AchievementEligibilityMechanic(Ach_Undevoured, Mech_UndevouredKept, new (Symbols.DiamondWide, Colors.Blue), new("Undev.Achiv.K", "Achievement Eligibility: Undevoured Kept", "Achiv Undevoured Kept"))
                            .UsingChecker((evt, log) => !evt.Lost)
                ]),
            ]),
        ])
