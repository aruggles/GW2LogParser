...
internal class Gorseval : SpiritVale
{
    internal readonly MechanicGroup Mechanics = new([
            new PlayerDstHealthDamageHitMechanic(SpectralImpact, Mech_SpectralImpact, new (Symbols.Hexagram,Colors.Red), new("Slam", "Spectral Impact (KB Slam)","Slam"), Sev0, 4000)
                .UsingBuffChecker(Stability, false),
            new PlayerDstBuffApplyMechanic(GhastlyPrison, Mech_GhastlyPrison, new (Symbols.Circle,Colors.LightOrange), new("Egg", "Ghastly Prison (Egged)","Egged"), Sev0, 500),
            new PlayerDstBuffApplyMechanic(SpectralDarkness, Mech_SpectralDarkness, new (Symbols.Circle,Colors.Blue), new("Orb Debuff", "Spectral Darkness (Stood in Orb AoE)","Orb Debuff"), Sev0, 100),
            new EnemyDstBuffApplyMechanic(SpiritedFusion, Mech_SpiritedFusion, new (Symbols.Square,Colors.LightOrange), new("Spirit Buff", "Spirited Fusion (Consumed a Spirit)","Ate Spirit"), Sev2),
            new PlayerDstHealthDamageHitMechanic(SpiritKick, Mech_SpiritKick, new (Symbols.TriangleRight,Colors.Magenta), new("Kick.S", "Kicked by small add","Spirit Kick"), Sev0)
                .UsingBuffChecker(Stability, false),
            new MechanicGroup([
                new PlayerDstBuffApplyMechanic(Vulnerability, Mech_GorsevalBlackGoo, new (Symbols.Circle,Colors.Black), new("Black", "Hit by Black Goo","Black Goo"), Sev1,3000)
                    .UsingChecker( (ba,log) => ba.AppliedDuration == 10000),
                new EnemyCastStartMechanic(GhastlyRampage, Mech_GhastlyRampageCast, new (Symbols.DiamondTall,Colors.DarkTeal), new("CC.G", "Ghastly Rampage (Breakbar)","Breakbar"), Sev3),
                new EnemyCastEndMechanic(GhastlyRampage, Mech_GhastlyRampageCastFail, new (Symbols.DiamondTall,Colors.Red), new("CC.G End", "Ghastly Rampage (Full duration)","CC ran out"), Sev1)
                    .UsingChecker( (ce,log) => ce.ActualDuration > 21985),
                new EnemyCastEndMechanic(GhastlyRampage, Mech_GhastlyRampageCastSuccess, new (Symbols.DiamondTall,Colors.DarkGreen), new("CCed.G", "Ghastly Rampage (Breakbar broken)","CCed"), Sev0)
                    .UsingChecker((ce, log) => ce.ActualDuration <= 21985),
            ]),
        ]);
