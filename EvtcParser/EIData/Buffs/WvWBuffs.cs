...
internal static class WvWBuffs
{
    ...
    [
        ...
        new Buff("Righteous Indignation", RighteousIndignation, Source.Common, BuffClassification.Other, SkillImages.Brilliance),
        ...
        new Buff("Marked (Red Sentry)", MarkedSentryRed, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Blue Sentry)", MarkedSentryBlue, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Green Sentry)", MarkedSentryGreen, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Red Tower)", MarkedTowerRed, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Blue Tower)", MarkedTowerBlue, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Green Tower)", MarkedTowerGreen, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Red Keep)", MarkedKeepRed, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Blue Keep)", MarkedKeepBlue, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Green Keep)", MarkedKeepGreen, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        ...
        new Buff("Dune Roller", DuneRoller, Source.Common, BuffClassification.Support, SkillImages.BattleRoar),
        new Buff("Invulnerable Dolyak", InvulnerableDolyak, Source.Common, BuffClassification.Other, SkillImages.Brilliance),
        ...
        new Buff("Commander's Presence", CommandersPresence, Source.Common, BuffClassification.Support, SkillImages.MightyBlow),
        new Buff("Inferno Hound", InfernoHound, Source.Common, BuffClassification.Other, SkillImages.HoundsOfBalthazar),
        new Buff("Smoke Form", SmokeForm, Source.Common, BuffClassification.Other, SkillImages.InkShot),
        new Buff("Chilling Fog", ChillingFog_HealingMistBuff, Source.Common, BuffClassification.Debuff, SkillImages.FreezingGust).WithBuilds(GW2Builds.StartOfLife, GW2Builds.May2024LonelyTowerFractalRelease),
        ...
        new Buff("Marked (Green Sentry Turret)", MarkedSentryTurretGreen, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Marked (Blue Sentry Turret)", MarkedSentryTurretBlue, Source.Common, BuffClassification.Debuff, SkillImages.FireTrebuchet),
        new Buff("Overgrowth Bonus Tier 1", OvergrowthBonusTier1, Source.Common, BuffClassification.Support, SkillImages.InvokeLightning),
        new Buff("Overgrowth Bonus Tier 2", OvergrowthBonusTier2, Source.Common, BuffClassification.Support, SkillImages.InvokeLightning),
        new Buff("Overgrowth Bonus Tier 3", OvergrowthBonusTier3, Source.Common, BuffClassification.Support, SkillImages.InvokeLightning),
