...
public abstract class IDBasedMechanic<Checkable> : CheckedMechanic<Checkable>
{
    ...
    protected IDBasedMechanic(long mechanicID, MechanicPlotlySetting plotlySetting, string shortName, string description, string fullName, int internalCoolDown) : base(plotlySetting, shortName, description, fullName, internalCoolDown)
    {
