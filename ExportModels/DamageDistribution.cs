...
namespace Gw2LogParser.ExportModels
{
    public class DamageDistribution
    {
        ...
        public static DamageDistribution BuildDMGTakenDistData(ParsedLog log, AbstractSingleActor p, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DamageDistribution BuildDMGDistDataInternal(ParsedLog log, FinalDPS dps, AbstractSingleActor p, AbstractSingleActor target, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DamageDistribution();
        ...
        public static DamageDistribution BuildFriendlyDMGDistData(ParsedLog log, AbstractSingleActor actor, AbstractSingleActor target, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        public static DamageDistribution BuildTargetDMGDistData(ParsedLog log, AbstractSingleActor npc, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
        ...
        private static DamageDistribution BuildDMGDistDataMinionsInternal(ParsedLog log, FinalDPS dps, Minions minions, AbstractSingleActor target, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            var dto = new DamageDistribution();
        ...
        public static DamageDistribution BuildFriendlyMinionDMGDistData(ParsedLog log, AbstractSingleActor actor, Minions minions, AbstractSingleActor target, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
            FinalDPS dps = actor.GetDPSStats(target, log, phase.Start, phase.End);
        ...
        public static DamageDistribution BuildTargetMinionDMGDistData(ParsedLog log, AbstractSingleActor target, Minions minions, PhaseData phase, Dictionary<long, SkillItem> usedSkills, Dictionary<long, Buff> usedBuffs)
        {
